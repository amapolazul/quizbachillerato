...
public class PreguntasLenguajeGrado8 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasLenguajeGrado8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_lenguaje_grado8);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasLenguajeGrado8);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasLenguajeGrado8);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoLenguajeG8);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasLenguajeGrado8 = quizDao.darPreguntas(CategoriasEnum.LENGUAJE.getValor(), "8");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasLenguajeGrado8.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoLenguajeG8);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaALenguajeG8);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBLenguajeG8);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCLenguajeG8);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDLenguajeG8);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasLenguajeGrado8.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, PreguntasCienciasGrado8.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_lenguaje_grado8, menu);
        return true;
    }

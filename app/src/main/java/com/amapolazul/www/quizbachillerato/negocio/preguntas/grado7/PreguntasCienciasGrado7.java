...
public class PreguntasCienciasGrado7 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasCienciasGrado7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_ciencias_grado7);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasCienciasGrado7);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasCienciasGrado7);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoCienciasG7);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasCienciasGrado7 = quizDao.darPreguntas(CategoriasEnum.CIENCIAS.getValor(), "7");
            inicializarQuiz();
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasCienciasGrado7.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoCienciasG7);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaACienciasG7);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBCienciasG7);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCCienciasG7);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDCienciasG7);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasCienciasGrado7.size()){
            inicializarQuiz();
        } else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_ciencias_grado7, menu);
        return true;
    }

...
public class PreguntasCienciasGrado8 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasCienciasGrado8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_ciencias_grado8);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasCienciasGrado8);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasCienciasGrado8);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoCienciasG8);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasCienciasGrado8 = quizDao.darPreguntas(CategoriasEnum.CIENCIAS.getValor(), "8");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasCienciasGrado8.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoCienciasG8);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaACienciasG8);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBCienciasG8);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCCienciasG8);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDCienciasG8);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasCienciasGrado8.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, PreguntasSocialesGrado8.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_ciencias_grado8, menu);
        return true;
    }

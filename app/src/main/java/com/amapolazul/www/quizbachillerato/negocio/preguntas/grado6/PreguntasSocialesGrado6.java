package com.amapolazul.www.quizbachillerato.negocio.preguntas.grado6;
...
public class PreguntasSocialesGrado6 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasSocialesGrado6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_sociales_grado6);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasSocialesGrado6);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasSocialesGrado6);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoSocialesG6);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasSocialesGrado6 = quizDao.darPreguntas(CategoriasEnum.SOCIALES.getValor(), "6");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasSocialesGrado6.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoSocialesG6);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaASocialesG6);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBSocialesG6);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCSocialesG6);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDSocialesG6);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasSocialesGrado6.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, PreguntasSocialesGrado6.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_sociales_grado6, menu);
        return true;
    }

...
public class PreguntasMatematicasGrado7 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasMatematicasGrado7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_matematicas_grado7);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasMatematicasGrado7);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasMatematicasGrado7);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoMatematicasG7);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasMatematicasGrado7 = quizDao.darPreguntas(CategoriasEnum.MATEMATICAS.getValor(), "7");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasMatematicasGrado7.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoMatematicasG7);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaAMatematicasG7);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBMatematicasG7);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCMatematicasG7);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDMatematicasG7);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasMatematicasGrado7.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, PreguntasLenguajeGrado7.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_matematicas_grado7, menu);
        return true;
    }

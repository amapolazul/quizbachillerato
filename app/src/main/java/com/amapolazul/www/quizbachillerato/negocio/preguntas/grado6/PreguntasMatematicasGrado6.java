...
public class PreguntasMatematicasGrado6 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasMatematicasGrado6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_matematicas_grado6);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasMatematicasGrado6);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasMatematicasGrado6);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoMatematicasG6);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasMatematicasGrado6.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoMatematicasG6);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaAMatematicasG6);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBMatematicasG6);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCMatematicasG6);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasMatematicasGrado6.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, PreguntasLenguajeGrado6.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_matematicas_grado6, menu);
        return true;
    }

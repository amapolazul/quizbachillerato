...
public class PreguntasCienciasGrado6 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasCienciasGrado6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_ciencias_grado6);

        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasCienciasGrado6);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasCienciasGrado6);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoCienciasG6);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasCienciasGrado6 = quizDao.darPreguntas(CategoriasEnum.CIENCIAS.getValor(), "6");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasCienciasGrado6.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoCienciasG6);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaACienciasG6);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBCienciasG6);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCCienciasG6);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDCienciasG6);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasCienciasGrado6.size()){
            inicializarQuiz();
        } else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_ciencias_grado6, menu);
        return true;
    }

...
public class PreguntasLenguajeGrado9 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasLenguajeGrado9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_lenguaje_grado9);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasLenguajeGrado9);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasLenguajeGrado9);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoLenguajeG9);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasLenguajeGrado9 = quizDao.darPreguntas(CategoriasEnum.LENGUAJE.getValor(), "9");
            inicializarQuiz();
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasLenguajeGrado9.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoLenguajeG9);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaALenguajeG9);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBLenguajeG9);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCLenguajeG9);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDLenguajeG9);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasLenguajeGrado9.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, PreguntasCienciasGrado9.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_lenguaje_grado9, menu);
        return true;
    }

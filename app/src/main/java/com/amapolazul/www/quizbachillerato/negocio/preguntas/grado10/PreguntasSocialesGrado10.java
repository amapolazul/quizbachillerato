...
public class PreguntasSocialesGrado10 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasSocialesGrado10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_sociales_grado10);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasSocialesGrado10);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasSocialesGrado10);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoSocialesG10);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasSocialesGrado10 = quizDao.darPreguntas(CategoriasEnum.SOCIALES.getValor(), "10");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasSocialesGrado10.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoSocialesG10);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaASocialesG10);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBSocialesG10);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCSocialesG10);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDSocialesG10);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_sociales_grado10, menu);
        return true;
    }

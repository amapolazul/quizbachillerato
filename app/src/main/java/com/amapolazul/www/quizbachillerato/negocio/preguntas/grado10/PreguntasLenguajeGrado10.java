...
public class PreguntasLenguajeGrado10 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasLenguajeGrado10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_lenguaje_grado10);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasLenguajeGrado10);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasLenguajeGrado10);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoLenguajeG10);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasLenguajeGrado10 = quizDao.darPreguntas(CategoriasEnum.LENGUAJE.getValor(), "10");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasLenguajeGrado10.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoLenguajeG10);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaALenguajeG10);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBLenguajeG10);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCLenguajeG10);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDLenguajeG10);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasLenguajeGrado10.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, PreguntasCienciasGrado10.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_lenguaje_grado10, menu);
        return true;
    }

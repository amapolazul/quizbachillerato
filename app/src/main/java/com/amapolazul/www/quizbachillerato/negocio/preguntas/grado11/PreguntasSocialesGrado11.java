...
public class PreguntasSocialesGrado11 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasSocialesGrado11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_sociales_grado11);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasSocialesGrado11);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasSocialesGrado11);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoSocialesG11);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasSocialesGrado11 = quizDao.darPreguntas(CategoriasEnum.SOCIALES.getValor(), "11");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasSocialesGrado11.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoSocialesG11);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaASocialesG11);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBSocialesG11);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCSocialesG11);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDSocialesG11);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasSocialesGrado11.size()){
            inicializarQuiz();
        } else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_sociales_grado11, menu);
        return true;
    }

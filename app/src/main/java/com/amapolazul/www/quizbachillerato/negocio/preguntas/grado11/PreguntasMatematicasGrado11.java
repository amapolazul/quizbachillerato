...
public class PreguntasMatematicasGrado11 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasMatematicasGrado11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_matematicas_grado11);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasMatematicasGrado11);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasMatematicasGrado11);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoMatematicasG11);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasMatematicasGrado11 = quizDao.darPreguntas(CategoriasEnum.MATEMATICAS.getValor(), "11");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasMatematicasGrado11.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoMatematicasG11);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaAMatematicasG11);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBMatematicasG11);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCMatematicasG11);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDMatematicasG11);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasMatematicasGrado11.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, PreguntasLenguajeGrado11.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_matematicas_grado11, menu);
        return true;
    }

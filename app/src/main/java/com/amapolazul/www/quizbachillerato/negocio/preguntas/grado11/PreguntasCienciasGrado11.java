...
public class PreguntasCienciasGrado11 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasCienciasGrado11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_ciencias_grado11);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasCienciasGrado11);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasCienciasGrado11);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoCienciasG11);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasCienciasGrado11 = quizDao.darPreguntas(CategoriasEnum.CIENCIAS.getValor(), "11");
            inicializarQuiz();
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasCienciasGrado11.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoCienciasG11);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaACienciasG11);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBCienciasG11);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCCienciasG11);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDCienciasG11);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasCienciasGrado11.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, PreguntasSocialesGrado11.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_ciencias_grado11, menu);
        return true;
    }

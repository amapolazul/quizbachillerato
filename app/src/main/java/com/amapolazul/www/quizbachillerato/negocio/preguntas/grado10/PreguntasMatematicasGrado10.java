...
public class PreguntasMatematicasGrado10 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasMatematicasGrado10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_matematicas_grado10);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasMatematicasGrado10);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasMatematicasGrado10);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoMatematicasG10);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasMatematicasGrado10 = quizDao.darPreguntas(CategoriasEnum.MATEMATICAS.getValor(), "10");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasMatematicasGrado10.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoMatematicasG10);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaAMatematicasG10);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBMatematicasG10);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCMatematicasG10);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDMatematicasG10);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasMatematicasGrado10.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, PreguntasLenguajeGrado10.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_matematicas_grado10, menu);
        return true;
    }

...
public class PreguntasMatematicasGrado9 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasMatematicasGrado9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_matematicas_grado9);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasMatematicasGrado9);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasMatematicasGrado9);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoMatematicasG9);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasMatematicasGrado9 = quizDao.darPreguntas(CategoriasEnum.MATEMATICAS.getValor(), "9");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasMatematicasGrado9.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoMatematicasG9);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaAMatematicasG9);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBMatematicasG9);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCMatematicasG9);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDMatematicasG9);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasMatematicasGrado9.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, PreguntasLenguajeGrado9.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_matematicas_grado9, menu);
        return true;
    }

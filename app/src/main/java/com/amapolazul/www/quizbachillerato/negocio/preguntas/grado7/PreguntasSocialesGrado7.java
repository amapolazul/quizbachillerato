...
public class PreguntasSocialesGrado7 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasSocialesGrado7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_sociales_grado7);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasSocialesGrado7);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasSocialesGrado7);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoSocialesG7);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasSocialesGrado7 = quizDao.darPreguntas(CategoriasEnum.SOCIALES.getValor(), "7");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasSocialesGrado7.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoSocialesG7);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaASocialesG7);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBSocialesG7);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCSocialesG7);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDSocialesG7);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasSocialesGrado7.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, PreguntasSocialesGrado7.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_sociales_grado7, menu);
        return true;
    }

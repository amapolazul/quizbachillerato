...
public class PreguntasLenguajeGrado6 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasLenguajeGrado6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_lenguaje_grado6);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasLenguajeGrado6);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasLenguajeGrado6);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoLenguajeG6);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasLenguajeGrado6 = quizDao.darPreguntas(CategoriasEnum.LENGUAJE.getValor(), "6");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasLenguajeGrado6.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoLenguajeG6);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaALenguajeG6);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBLenguajeG6);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCLenguajeG6);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDLenguajeG6);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasLenguajeGrado6.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, PreguntasCienciasGrado6.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_lenguaje_grado6, menu);
        return true;
    }

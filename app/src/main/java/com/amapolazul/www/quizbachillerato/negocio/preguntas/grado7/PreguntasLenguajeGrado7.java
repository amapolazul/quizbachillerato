...
public class PreguntasLenguajeGrado7 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasLenguajeGrado7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_lenguaje_grado7);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasLenguajeGrado7);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasLenguajeGrado7);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoLenguajeG7);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasLenguajeGrado7 = quizDao.darPreguntas(CategoriasEnum.LENGUAJE.getValor(), "7");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasLenguajeGrado7.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoLenguajeG7);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaALenguajeG7);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBLenguajeG7);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCLenguajeG7);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDLenguajeG7);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasLenguajeGrado7.size()){
            inicializarQuiz();
        } else {
            Intent intent = new Intent(this, PreguntasCienciasGrado7.class);
            startActivity(intent);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_lenguaje_grado7, menu);
        return true;
    }

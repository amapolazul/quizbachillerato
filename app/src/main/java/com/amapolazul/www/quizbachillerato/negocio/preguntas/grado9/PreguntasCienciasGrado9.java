...
public class PreguntasCienciasGrado9 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasCienciasGrado9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_ciencias_grado9);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasCienciasGrado9);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasCienciasGrado9);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoCienciasG9);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasCienciasGrado9 = quizDao.darPreguntas(CategoriasEnum.CIENCIAS.getValor(), "9");
            inicializarQuiz();
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasCienciasGrado9.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoCienciasG9);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaACienciasG9);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBCienciasG9);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCCienciasG9);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDCienciasG9);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasCienciasGrado9.size()){
            inicializarQuiz();
        } else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_ciencias_grado9, menu);
        return true;
    }

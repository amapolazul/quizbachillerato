...
public class PreguntasSocialesGrado8 extends Activity {

    private QuizDAO quizDao;
    private int indicePrguntaActual;
    private Pregunta preguntaActual;
    private List<Pregunta> preguntasSocialesGrado8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preguntas_sociales_grado8);
        indicePrguntaActual = 0;
        contador = Contador.getInstance();
        contadorCorrectas = (TextView) findViewById(R.id.contadorCorrectasSocialesGrado8);
        contadorIncorrectas = (TextView) findViewById(R.id.contadorIncorrectasSocialesGrado8);
        ...
        TextView enunciado = (TextView) findViewById(R.id.enunciadoSocialesG8);
        enunciado.setMovementMethod(new ScrollingMovementMethod());
        try {
            quizDao = new QuizDAO(this);
            quizDao.open();
            preguntasSocialesGrado8 = quizDao.darPreguntas(CategoriasEnum.SOCIALES.getValor(), "8");
...
//            preguntaActual.setId(2340L);
    ...
    private void inicializarQuiz(){
        preguntaActual = preguntasSocialesGrado8.get(indicePrguntaActual);
        TextView enunciado = (TextView) findViewById(R.id.enunciadoSocialesG8);
        TextView respuestaA = (TextView) findViewById(R.id.respuestaASocialesG8);
        TextView respuestaB = (TextView) findViewById(R.id.respuestaBSocialesG8);
        TextView respuestaC = (TextView) findViewById(R.id.respuestaCSocialesG8);
        TextView respuestaD = (TextView) findViewById(R.id.respuestaDSocialesG8);
    ...
    private synchronized void reiniciarRespuestasYAvanzar() throws InterruptedException {
        ...
        if(indicePrguntaActual < preguntasSocialesGrado8.size()){
            inicializarQuiz();
        } else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_preguntas_sociales_grado8, menu);
        return true;
    }
